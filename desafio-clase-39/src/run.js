...
import SessionsViewRouter from './routers/views/sessions.router.js'
...
const sessionsViewRouter = new SessionsViewRouter();                             
...
const run = (socketServer, app) => {
    ...
    app.use('/session', sessionsViewRouter.getRouter())
