...
export default () => {
    describe('Test de Productos', () => {
        ...
        it('Debe poder crearse un producto con la ruta de la imagen si el usuario esta logueado', async function() {
            const result = await requester.post('/api/session/login').send({email: env_parameters_obj.admin.adminEmail, password: env_parameters_obj.admin.adminPassword})
        ...
        it('No se debe poder eliminar un producto si el usuario esta logueado pero tiene rol user', async function () {
            ...
            // logueo el usuario
            const loggedUser = await requester.post('/api/session/login').send({email: mockUser.email, password: mockUser.password})
        ...
        after( async function () {
            ...
            await requester.delete(`/api/session/${idRegisteredUser}`).set('Cookie', [`${cookieNewUser.name}=${cookieNewUser.value}`])
        })
    })
}